...
feature {ANY}
   ...
   get_student_addr():STRING  deferred end  -- override and read the renamed field!
   get_faculty_addr():STRING  deferred end  -- override and read the renamed field!
   set_student_addr(a:STRING) deferred end  -- override and write to the renamed field!
   set_faculty_addr(a:STRING) deferred end  -- override and write to the renamed field!
